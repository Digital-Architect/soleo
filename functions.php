<?php
	...
	function my_theme_setup(){
		load_theme_textdomain('wp_soleo', get_template_directory() . '/language');
	}
...
//addtional admin options for header
...
//
function register_additional_customizer_tel( $wp_customize ) {
    ...
    $wp_customize->add_control( new WP_Customize_Control(
        ...
        'company_tel',
        array(
            'label'      => __( 'Company Telephone', 'comp_tel' ),
            'description' => __( 'Enter the telephone number to display on the website', 'comp_tel' ),
...
add_action( 'customize_register', 'register_additional_customizer_tel' );



function register_additional_customizer_cta( $wp_customize ) {
    $wp_customize->add_setting(
        'company_cta',
        array(
            'default' => '',
    ...
    $wp_customize->add_control( new WP_Customize_Control(
        ...
        'company_cta',
        array(
            'label'      => __( 'CTA Title', 'cta_title' ),
            'description' => __( 'Enter the CTA title for the header button', 'cta_title' ),
            'settings'   => 'company_cta',
            'priority'   => 10,
            'section'    => 'title_tagline',
            'type'       => 'text',
        )
...
add_action( 'customize_register', 'register_additional_customizer_cta' );



function register_additional_customizer_cta_link( $wp_customize ) {
    $wp_customize->add_setting(
        'company_cta_link',
        array(
            'default' => '',
    ...
    $wp_customize->add_control( new WP_Customize_Control(
        ...
        'company_cta_link',
        array(
            'label'      => __( 'CTA Link', 'cta_title_link' ),
            'description' => __( 'Enter the CTA link for the header button', 'cta_title_link' ),
            'settings'   => 'company_cta_link',
            'priority'   => 10,
            'section'    => 'title_tagline',
            'type'       => 'text',
        )
...
add_action( 'customize_register', 'register_additional_customizer_cta_link' );
